...
module Shumway.flash.display {
	...
	export class ShaderJob extends flash.events.EventDispatcher {
		...
		set shader(s: flash.display.Shader) {
			s = s;
			release || notImplemented("public flash.display.ShaderJob::set shader");
			return;
			// this._shader = s;
		}
		...
		set target(s: ASObject) {
			s = s;
			release || notImplemented("public flash.display.ShaderJob::set target");
			return;
			// this._target = s;
		}
		...
		set width(v: number /*int*/) {
			v = v | 0;
			release || notImplemented("public flash.display.ShaderJob::set width");
			return;
			// this._width = v;
		}
		...
		set height(v: number /*int*/) {
			v = v | 0;
			release || notImplemented("public flash.display.ShaderJob::set height");
			return;
			// this._height = v;
		}
		...
		start(waitForCompletion: boolean = false): void {
			...
			release || notImplemented("public flash.display.ShaderJob::start");
			return;
		}

		cancel(): void {
			release || notImplemented("public flash.display.ShaderJob::cancel");
			return;
		}
	}
}
